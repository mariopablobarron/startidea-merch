      ...
      <div style="font-family:Helvetica,Arial,sans-serif;background:#F4EFE6;padding:32px 16px;">
        <div style="max-width:600px;margin:0 auto;background:#FFFFFF;border-radius:16px;overflow:hidden;color:#2A2A2A;">
          ...
          <div style="padding:0 32px 16px;">
            ...
            <div style="background:#FBDFE9;border:2px dashed #E63E73;padding:18px;text-align:center;border-radius:12px;margin-top:8px;">
              <p style="margin:0;font-family:monospace;font-size:16px;color:#E63E73;word-break:break-all;">${refLink}</p>
            </div>
          ...
          <div style="padding:8px 32px 32px;text-align:center;">
            <a href="${dashboardUrl}" style="display:inline-block;background:#E63E73;color:#FFFFFF;text-decoration:none;padding:14px 32px;border-radius:999px;font-size:15px;font-weight:600;">Ver mi dashboard →</a>
