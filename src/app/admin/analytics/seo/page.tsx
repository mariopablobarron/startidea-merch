      ...
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <header className="mb-6 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <a
              href="https://search.google.com/search-console?resource_id=https://merchandising.hubstartidea.es/"
              target="_blank"
              rel="noopener"
        ...
        <>
          ...
          <ol className="space-y-4 text-sm text-ink/80">
            <Step n={1}>
              ...
              (selecciona <code className="rounded bg-bone-soft px-1.5 py-0.5 font-mono text-xs">https://merchandising.hubstartidea.es</code>)
